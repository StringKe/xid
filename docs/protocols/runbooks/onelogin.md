...
- Provider: `OneLogin`; direction: `inbound`.
...
- BLOCKED evidence: record missing OneLogin admin access, isolated test tenant, callback domain, test user, assignment, or signing material. Do not record secrets, complete assertions, or personal data.
