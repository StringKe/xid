...
---
<!-- Generated by stdagent 0.0.10. Source: .stdai/standards/references/oauth-advanced-security-status.md. Run `stdagent sync` to regenerate. Do not edit by hand. -->
<!-- std-agent degraded references: oauth-advanced-security-status -->
