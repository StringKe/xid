...
---
<!-- Generated by stdagent 0.0.10. Source: .stdai/standards/references/lingui-setup-reference.md. Run `stdagent sync` to regenerate. Do not edit by hand. -->
<!-- std-agent degraded references: lingui-setup-reference -->
