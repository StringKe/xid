...
---
<!-- Generated by stdagent 0.0.10. Source: .stdai/standards/references/tenant-scoped-query-api.md. Run `stdagent sync` to regenerate. Do not edit by hand. -->
<!-- std-agent degraded references: tenant-scoped-query-api -->
