...
const allowedSameAsSource = new Set([
  ...
  'admin, owner',
  'user_abc, user_def',
  // 阶段5/5.5 新增:包名 / 函数名 / URL / 颜色 / 占位符 / 逗号分隔事件名与错误码列表等不可译标识符(填原文)。
  '#10b981',
  '#6366f1',
  '#ffffff',
  '+15550000000',
  ...
  'verifyWebhook',
  'xxxxxxxx',
  // catalog.test 二轮:分类器漏掉的代码标识符 / 框架词 / 环境变量列表 / hook 签名 / 字体栈 / 事件名(译者正确保留英文)。
  'Events API',
  'Hook',
  'Hooks',
  ...
  // catalog.test 三轮:SDK/SSO 文档里的品牌/产品/协议专名,CJK 文档惯例保留英文。
  'AD FS',
  'Android',
  'Apple',
  'Atlassian',
  ...
  'iOS',
  'macOS',
  // catalog.test 四轮:全生态 SDK 矩阵的运行时/语言/框架专名,CJK 文档惯例保留英文。
  '.NET',
  'Angular',
  'Astro',
  'Bun',
  ...
  'Vue',
  'Windows',
  // landing v2:协议专名串与延迟标注,CJK 之外保留英文原文(设计稿口径)。
  'OIDC · OAuth IdP',
  '0 RTT',
  // console 重设计:fr 的 session 与英文同拼写,ICU plural 串与源同形。
  '{sessionCount, plural, one {# session} other {# sessions}}',
  // SDK 详情页收口:依赖版本号/平台最低版本/导出类型与服务名/TS 类型字面量/标识符列表/协议字段,均为代码事实(填原文)。
  '^1.2.2',
  '^3.0.3',
  '^4.0.0',
  '^9.2.4',
  ...
  '5 minutes',
  // 阶段6/文档:协议专名与技术标识符,CJK 文档惯例保留英文。
  'ACS URL',
  'ETag and If-Match',
