// @xid-kit/vue:Vue 3 SDK(对标 @xid-kit/react 的 Vue 对等层)。
// 职责:XidPlugin(app.use 注入 client)、composables(useXid/useAuth/useUser/useOrganization/useSession)、
//      预制组件(SignInButton/SignOutButton/Protect 最小集)。
// 框架层只做响应式接线,不重写协议逻辑(复用 @xid-kit/core)。
