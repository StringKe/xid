...
//
// onRequest: default no-op middleware handler exported for xidIntegration's addMiddleware
// entrypoint. Consumers who need custom jwtKey/protectedRoutes should use createXidMiddleware
// in their own src/middleware.ts rather than relying on this default export.
// This export satisfies Astro's requirement that the middleware entrypoint file exports `onRequest`.
