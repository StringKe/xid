...
Fallback channel: email **security@xid.dev**. Use this if private vulnerability reporting is
unavailable. Encrypt the message if the finding is severe and you have a way to do so; ask for a key
in a first contact message that contains no details.
