---
name: ui-polish
description: "Complete execution rules for detail and motion polish on XID product interfaces and Nimbus documentation. Covers alignment, spacing, typography, contrast, interaction states, motion, copy, edge states, responsiveness, performance, and code A reviewer says the details are unfinished, final polish before shipping, filling in missing interaction states, adding or tuning motion, fixing alignment and spacing, or the last quality pass before release"
metadata:
    category: frontend
