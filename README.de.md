...
Workers nicht korrekt deployt**. Die acht Durable-Object-Bindings, das Analytics-Engine-Dataset,
...
Core-Worker-intern. Kryptografische Primitive stammen immer aus Web Crypto, XML-DSig ist an `xmldsigjs`
